...
export default function ReportPending(props) {
  ...
  const resolveStoreReport = async (id) => {
    const obj = {
      id: id,
    };
  ...
  const resolveUserReport = async (id) => {
    const obj = {
      id: id,
    };
